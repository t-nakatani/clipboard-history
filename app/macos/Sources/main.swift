...
func runBindingSelfTest() -> Int32 {
    ...
    // Marker matching is case-insensitive and evaluated across every advertised type.
    let concealedMarkers = ["org.nspasteboard.ConcealedType", "com.agilebits.onepassword"]
    ...
    for marker in transientMarkers {
        guard evaluateCaptureTypes(pasteboardTypes: ["public.utf8-plain-text", marker]) == .rejectTransient else {
